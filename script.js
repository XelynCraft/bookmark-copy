// This is the part I'm supposed to edit, the other files are to remain untouched//
...
// ...
linkEl.classList.add("background-color", "href", "target");
...
// ...
image.innerHTML = "src= https://www.google.com/s2/favicons?domain=" + url
// ----------------- Part 4 ----------------- //
...
for (let i = 0; document.getElementById("url" + i); i++){
    selectedLinks[i] = document.getElementByID("url" + i).value;
...
let addedForm = document.getElementById("add-form");
formAddButton.addEventListener("click", function showForm(){
    if (addedForm.style.visibility === "visible"){
        addedForm.style.visibility = "hidden";
    } else {
        addedForm.style.visibility = "visible";
    }
})
...
let hiddenForm = document.getElementById("add-form");
...
let color = document.getElementById("form-modal");
